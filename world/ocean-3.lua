...
lev:set_trackheight( 0.5 )
lev:set_tracksize( 2.5, 2.5, 7, 7 ) -- cellsizex,cellsizey,numcellsx,numcellsy
...
lev:set_end( 3.75, 1.25, 1.0 )
lev:add_painter( 8.75,  16.0,  1.0, 'R' )
lev:add_painter( 13.75, 11.25, 1.0, 'G' )
lev:add_painter( 16.0,  16.0,  1.0, 'B' )

lev:set_startcolour( 'B' )
lev:set_startposition( 8.75, 3.75, 0.0, 0.0 )
